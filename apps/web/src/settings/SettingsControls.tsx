...
export function SettingsButton({
  ...
  return (
    <Button variant="outline" size="icon" title={title} aria-label={title} onClick={onClick} className={className}>
...
export function SettingsButtonGroup({
  ...
  return (
    <ButtonGroup aria-label="Appearance and settings controls">
      <ThemeToggle
        darkMode={darkMode}
